/**
 * 🔐 LOGIN USE CASE - avec cookies et session Redis
 *
...
export class LoginWithCookiesUseCase {
  ...
  async execute(
    ...
    try {
      ...
      // 4. 🍪 Définir les cookies sécurisés
      ...
      // 5. 👤 Stocker la session utilisateur dans Redis
  ...
  private async setAuthCookies(
    ...
    // 🔄 Cookie Refresh Token (longue durée ou session)
