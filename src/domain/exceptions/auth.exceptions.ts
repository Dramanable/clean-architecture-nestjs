...
export class InvalidRefreshTokenError extends AuthenticationError {
  constructor(message: string = 'Invalid refresh token', context?: Record<string, any>) {
...
export class TokenRepositoryError extends AuthenticationError {
  constructor(message: string = 'Token repository operation failed', context?: Record<string, any>) {
...
export class UserNotFoundError extends AuthenticationError {
  constructor(message: string = 'User not found', context?: Record<string, any>) {
