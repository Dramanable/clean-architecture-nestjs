    ...
    questions: {
      type: {
        ...
        enum: {
          ...
          '♻️ refactor': {
            description: '♻️ Un changement de code qui ne corrige pas de bug ni n\'ajoute de fonctionnalité',
          ...
          '🔧 chore': {
            description: '🔧 Changements aux outils de build ou dépendances auxiliaires',
            title: 'Chores',
            emoji: '🔧',
          },
          '🚀 ci': {
      ...
      issues: {
        description: 'Ajoutez les références d\'issues (ex: "fix #123", "re #123")',
      },
    },
  },
};
